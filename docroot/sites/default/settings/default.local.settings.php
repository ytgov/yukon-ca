...
$db_name = !isset($_ENV['MYSQL_DATABASE']) ? '${drupal.db.database}' : $_ENV['MYSQL_DATABASE'];
...
$databases['default']['default'] = [
  'database' => $db_name,
  'username' => !isset($_ENV['MYSQL_USER']) ? '${drupal.db.username}' : $_ENV['MYSQL_USER'],
  'password' => !isset($_ENV['MYSQL_PASSWORD']) ? '${drupal.db.password}' : $_ENV['MYSQL_PASSWORD'],
