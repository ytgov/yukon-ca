...
class ImportDataController extends ControllerBase
{
    ...
    {
        return new self($container->get("messenger"));
    }
            ...
            foreach ($primary_cont as $secondary_cont) {
                ...
                if (empty($primary_fr)) {
                    ...
                    if (!empty($primary_en[0]->id)) {
                        ...
                        $query = $db->select(
                            "paragraph__field_landing_page_level_2",
                            "i"
                        );
                        $query->fields("i", []);
                        ...
                        foreach ($primary_popular as $populer) {
                            ...
                            $result = $db
                                ->insert(
                                    "paragraph_revision__field_landing_page_level_2"
                                )
                                ->fields([
                                    "bundle" => $populer->bundle,
                                    "deleted" => $populer->deleted,
                        ...
                        $query = $db->select(
                            "paragraph__field_subcategory_links",
                            "i"
                        );
                        $query->fields("i", []);
                        $query->condition("i.bundle", "secondary_content");
                            ...
                            $result = $db
                                ...
                                ->fields([
                                    ...
                                    "field_subcategory_links_title" =>
                                        $populer->field_subcategory_links_title,
                                    "field_subcategory_links_options" =>
                                        $populer->field_subcategory_links_options,
                                ])
                                ->execute();

                            $result = $db
                                ->insert(
                                    "paragraph_revision__field_subcategory_links"
                                )
                                ->fields([
                                    "bundle" => $populer->bundle,
                                    "deleted" => $populer->deleted,
                        ...
                        $query = $db->select(
                            "paragraph__field_category_title",
                            "i"
                        );
                        $query->fields("i", []);
                        $query->condition("i.bundle", "secondary_content");
                        ...
                        foreach ($primary_popular as $populer) {
                            ...
                            $result = $db
                                ->insert(
                                    "paragraph_revision__field_category_title"
                                )
                                ->fields([
                                    "bundle" => $populer->bundle,
                                    "deleted" => $populer->deleted,
                        ...
                        $query = $db->select(
                            "paragraph__field_use_landing_page_level_2_a",
                            "i"
                        );
                        $query->fields("i", []);
                        $query->condition("i.bundle", "secondary_content");
